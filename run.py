...
def get_sales_data():
    ...
    """
    while True:
        print("Please enter sales data from the laste market.")
...
def validate_data(values):
    ...
    Raises ValueError if the starings cannot be converted into int, 
...
def calculate_surplus_data(sales_row):
    """
    Caompare sales with stock and calculate the surplus for each item type.

    The surplus is defined as the sales figure substracted from the stock.
    Positive surplus indicate waste.
    Negative surplus indicates made when stock run out.
    """
